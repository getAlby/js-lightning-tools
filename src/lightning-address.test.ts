...
for (const proxy of [DEFAULT_PROXY, false] as const) {
  describe("with proxy: " + proxy, () => {
    ...
    describe("boost", () => {
      ...
      it(
        "successful boost returns preimage",
        async () => {
          const ln = new LightningAddress("hello@getalby.com", {
            proxy,
            webln: dummyWebLN,
    ...
    describe("zap", () => {
      ...
      it(
        "successful zap returns preimage",
        async () => {
          const ln = new LightningAddress("hello@getalby.com", {
            proxy,
            webln: dummyWebLN,
    ...
    describe("fetch", () => {
      it(
        "retrieves lnurlp data for lightning address without keysend or nostr",
        async () => {
          // TODO: consider mocking responses
      ...
      it(
        "can fetch existing lightning address without nostr configuration",
        async () => {
          // TODO: consider mocking responses
      ...
      it(
        "does not throw error when requesting non-existing lightning address",
        async () => {
          const ln = new LightningAddress(
            "hellononexistentaddress@getalby.com",
            { proxy },
          );
          await ln.fetch();
